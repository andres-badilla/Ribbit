...
public class MainActivity extends Activity implements ActionBar.TabListener {
                ...
                private Uri getOutputMediaFileUri(int mediaType) {
                    ...
                    if(isExternalStorageAvailable()){
                        ...
                        File mediaStorageDir = new File(
                                ...
                                appName);//File could be a file or a directory
                        ...
                        if(mediaType == MEDIA_TYPE_IMAGE) mediaFile = new File(path+"IMG_"+timestamp+".jpg");
                        else if(mediaType== MEDIA_TYPE_VIDEO) mediaFile = new File(path+"VID_"+timestamp+".mp4");
                        else return null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < mSectionsPagerAdapter.getCount(); i++) {
            actionBar.addTab(
                    actionBar.newTab()
                            //Removed to set an Icon instead of the name
